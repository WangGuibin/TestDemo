//
//  WGBAudioEncoderViewController.m

//
//  Created by 王贵彬 on 2023/5/10.
//

#import "WGBAudioEncoderViewController.h"
...
@interface WGBAudioEncoderViewController ()
...
@implementation WGBAudioEncoderViewController
    ...
    if (!_audioEncoder) {
        ...
        _audioEncoder.sampleBufferOutputCallBack = ^(CMSampleBufferRef sampleBuffer) {
            if (sampleBuffer) {
                ...
                [weakSelf.fileHandle writeData:[WGBAudioTools adtsDataWithChannels:audioFormat.mChannelsPerFrame sampleRate:audioFormat.mSampleRate rawDataLength:totolLength]];
