...
typedef struct WGBAudioUserData {
    UInt32 mChannels;
    UInt32 mDataSize;
    void *mData;
...
@implementation WGBAudioDecoder

#pragma mark - Lifecycle
- (instancetype)init {
    self = [super init];
    if (self) {
        _decoderQueue = dispatch_queue_create("com.pcm.audioDecoder", DISPATCH_QUEUE_SERIAL);
    }
...
static OSStatus inputDataProcess(AudioConverterRef inConverter, UInt32 *ioNumberDataPackets, AudioBufferList *ioData, AudioStreamPacketDescription **outDataPacketDescription, void *inUserData) {
    WGBAudioUserData *userData = (WGBAudioUserData *) inUserData;
