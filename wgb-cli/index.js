...
console.log(chalk.yellow(figlet.textSync('CoderWGB', {
...
program.on('--help', () => {
    console.log();
    console.log(`  create by ${chalk.cyan('CoderWGB')} 哈哈哈哈哈哈嗝`);
    console.log(`  more click ${chalk.red('https://github.com/Wangguibin/hexo-github-action')}`)
    console.log();
});
