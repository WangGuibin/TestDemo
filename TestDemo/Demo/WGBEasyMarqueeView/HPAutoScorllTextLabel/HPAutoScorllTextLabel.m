...
@interface HPAutoScorllTextLabel(){
    CGFloat _width;
    CGFloat _height;
    CGFloat _textWidth;
    NSTimer *_timer;
...
@implementation HPAutoScorllTextLabel
...
- (void)initUSerInterface {
    ...
    _style = HPTextCycleStyleDefault;
    [self creatLabel];
}
...
- (void)labelChange {
    ...
    if (_style == HPTextCycleStyleDefault && _textWidth < _width) {
        [self stop];
        return;
    }
...
- (void)setStyle:(HPTextCycleStyle)style {
    _style = style;
    [self start];
}
